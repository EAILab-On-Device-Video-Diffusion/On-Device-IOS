    ...
    func generateImages(_ parameter: GenerationParameter) {
        ...
        Task.detached(priority: .high) {
            ...
            if await self.sdPipeline == nil {
                ...
                guard let path = Bundle.main.path(forResource: "CoreMLModels", ofType: nil) else {
              ...
              if let pipeline = try? StableDiffusionPipeline(resourcesAt: resourceURL, controlNet: [],configuration: config, reduceMemory: reduceMemory) {
